                            ...
                            @foreach ($list_paramedik as $paramedik)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-primary" href="delete_paramedik.php?iddel=<?= $paramedik['id'] ?>" onclick="if(!confirm('Anda Yakin Hapus Data kelurahan <?= $paramedik['nama'] ?>?')) {return false}">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
